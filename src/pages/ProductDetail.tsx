                    ...
                    {images.length === 0 || imgError ? (
                      ...
                      <>
                        <img
                          ...
                          alt={product.name}
                          className={`object-cover w-full h-full rounded-lg transition-opacity duration-300 scale-125 object-left ${imgLoading ? 'opacity-0' : 'opacity-100'}`}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="space-y-1">
                            ...
                            <div className="flex justify-between py-1 border-b border-muted/30">
                              ...
                              <span className="text-muted-foreground text-xs">
                                {product.name.toLowerCase().includes('boxed') ? '18.2 kg/m²' : '15.9 kg/m²'}
                              </span>
                            </div>
                            <div className="flex justify-between py-1 border-b border-muted/30">
