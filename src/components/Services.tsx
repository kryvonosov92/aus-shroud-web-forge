...
import { Eye, Sun, Palette } from "lucide-react";
    ...
    <section id="services" className="py-20 bg-secondary/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">Window shrouds are fast becoming a staple in contemporary architectural design. Enhance your project's visual appeal with our Aluminium Shrouds.</p>
        </div>
